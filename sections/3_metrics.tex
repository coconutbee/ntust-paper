...
Sec.~\ref{sec:exp_penalized}. \revised{The penalty term $e^{-kP_e}$ is a design
choice rather than a measured ground truth---App.~\ref{sec:appendix_profile}
argues for its validity by relating it to the independently-motivated PAEs
correction, rather than by re-synthesizing each reference at the achieved
pose.}
