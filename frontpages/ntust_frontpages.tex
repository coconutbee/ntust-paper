...
\begin{figure}[htbp]
    \centering
    \includegraphics[width=1in]{frontpages/NTUSTLogo.png}
    \label{fig:ntust_logo}
\end{figure}
	
\centering
\makebox[6cm][s]{\textbf{\Large{\univCname}}}\\  %顯示中文校名
%\vspace{0.5cm}
\makebox[4.4cm][s]{\textbf{\Large{\deptCname}}}\\ %顯示中文系所名
%\vspace{0.5cm}

%\hfill
\makebox[4.4cm][s]{\textbf{\Large{\degreeCname 論文}}}\\ %顯示論文種類 (中文)
%\makebox[8cm][s]{\textbf{\Huge{\degreeCname 論文（初稿）}}}\\ %顯示論文種類 (中文)
{
\linespread{0.1} \selectfont
\null\hfill {學號：M11307322}
\rule{16cm}{1pt}
}
...
\makebox[3cm][s]{\Large{\myCname}}  % 顯示作者中文名
\hfill \makebox[1cm][s]{}\\
%

%\vspace{1cm}
\hspace{4.5cm} \makebox[3cm][s]{\Large{指導教授：}}
\makebox[3cm][s]{\Large{\advisorCnameA}}  %顯示指導教授A中文名
\hfill \makebox[1cm][s]{}\\
%
% 判斷是否有共同指導的教授 B
...
\makebox[3cm][s]{\Large{\advisorCnameB}}  %顯示指導教授B中文名
\hfill \makebox[1cm][s]{}\\
\fi
%
% 判斷是否有共同指導的教授 C
...
% 共同指導的教授 C
\hspace{4.5cm} \makebox[3cm][s]{}
\makebox[3cm][s]{\Large{\advisorCnameC}}  %顯示指導教授C中文名
\hfill \makebox[1cm][s]{}\\
\fi
%
\vfill
\makebox[10cm][s]{\Large{中華民國 一一五 年 六 月 十三 日}}%
%
\end{center}
...
% 目前送出空白頁
% Re-enabled (real 2.0.1 source ships this commented out, matching 1.7.1's
% own note that it's "no longer necessary" per a 2018 rule change -- kept
% active here since a thesis submission genuinely needs this placeholder/TOC
% entry for the signed recommendation letter to be bound in later).
% \newpage{\thispagestyle{empty}\addcontentsline{toc}{chapter}{\nameInnerCover}\mbox{}\clearpage}%
% (Removed placeholder blank page for \nameInnerCover at user's request.)
%\newpage
...
% Re-enabled, same reasoning as \nameInnerCover above.
% \newpage{\thispagestyle{empty}\addcontentsline{toc}{chapter}{\nameCommitteeForm}\mbox{}\clearpage}%
% (Removed placeholder blank page for \nameCommitteeForm at user's request.)
