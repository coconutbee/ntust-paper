...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Cover layout ported from https://github.com/clw8998/Master-Thesis (banner
% logo + double-rule title block + right-aligned student ID), keeping this
% repo's own macro names (\cTitle, \myCname, \advisorCnameA/B/C, ...) so
% frontpages/my_names.tex still drives every field.
\begin{titlepage}
% no page number
...
\begin{minipage}{0.7\textwidth}
    \centering
    \includegraphics[width=\textwidth]{frontpages/NTUSTEELogo.png}
\end{minipage}

\vspace{0.5cm}
\hspace*{1cm}{\Huge\bfseries \degreeCname 學位論文}\par

\vspace{0.75cm}

\noindent
\makebox[\textwidth][r]{%
  \raisebox{0.ex}{\fontsize{14pt}{14pt}\selectfont 學號：\myStudentID}%
}

% 上細
\rule{\textwidth}{0.4pt}\\[-16pt]
% 下粗
\rule{\textwidth}{4pt}\\[1cm]
...
% option s: stretch
% use \makebox to make sure each info line's label/value boxes line up
\begin{minipage}{0.9\textwidth}
\begin{center}
\makebox[3cm][s]{\Large{研究生}}{\Large{：}}\makebox[3cm][s]{\Large{\myCname}}\par\vspace{0.5cm}
%
\makebox[3cm][s]{\Large{指導教授}}{\Large{：}}\makebox[3cm][s]{\Large{\advisorCnameA}}\par\vspace{0.5cm}
%
% 判斷是否有共同指導的教授 B
...
\else
% 共同指導的教授 B
\makebox[3cm][s]{}{\Large{：}}\makebox[3cm][s]{\Large{\advisorCnameB}}\par\vspace{0.5cm}
\fi
%
% 判斷是否有共同指導的教授 C
...
\else
% 共同指導的教授 C
\makebox[3cm][s]{}{\Large{：}}\makebox[3cm][s]{\Large{\advisorCnameC}}\par\vspace{0.5cm}
\fi
\end{center}
\end{minipage}
...
% Signed recommendation form (scanned from the student information system),
% bound right after the cover.
\newpage{\thispagestyle{empty}\addcontentsline{toc}{chapter}{\nameInnerCover}%
\begin{center}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/suggest.jpg}
\end{center}
\clearpage}%
...
% Signed qualification form (scanned from the student information system),
% bound right after the recommendation form.
\newpage{\thispagestyle{empty}\addcontentsline{toc}{chapter}{\nameCommitteeForm}%
\begin{center}
\includegraphics[width=\textwidth,height=\textheight,keepaspectratio]{figures/review_doc.png}
\end{center}
\clearpage}%
...
%\vspace{0.83cm}
%\vfill
\makebox[2.5cm][s]{\textbf{\LARGE{中文摘要}}}\\
\end{center}
% Resume the line spacing to the desired setting
\renewcommand{\baselinestretch}{\mybaselinestretch}   %恢復原設定
%it needs a font size changing command to be effective
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% Symbol list -- re-enabled (real source ships this commented out/opt-in);
% this thesis has a symbol table (frontpages/my_symbols.tex) to show.
