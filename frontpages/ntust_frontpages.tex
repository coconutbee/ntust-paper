...
\Large{\cTitle}\\	% Chinese title 中文題目 -- shown on the "Chinese Version" cover
% (the upstream "English Version" template leaves this commented out and
% shows only the English title; NTUST reg. requires the cover to be
% bilingual, so this branch restores it.)
\vspace{1cm}
%
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%       中文摘要
%       (template 原版此區塊整段被 comment 掉，僅供英語畢業生使用；
%        NTUST 規範要求無論論文語言為何皆須附中文摘要，故改寫成一個
%        乾淨版本，結構仿照下方保留原樣的英文摘要區塊。)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\chapter*{\protect\makebox[3cm][s]{\nameCabstract}}
\addcontentsline{toc}{chapter}{\nameCabstract}
\begin{center}
\renewcommand{\baselinestretch}{1}
\large{\cTitle}\\[0.3cm]
\makebox[1.5cm][s]{\large{學生：}}\makebox[3cm][l]{\large{\myCname}}\hfill
\makebox[3cm][s]{\large{指導教授：}}\makebox[3cm][l]{\large{\advisorCnameA}}\\
\ifx \advisorCnameB \itsempty \relax \else
\makebox[1.5cm][s]{}\makebox[3cm][l]{}\hfill
\makebox[3cm][s]{}\makebox[3cm][l]{\large{\advisorCnameB}}\\
\fi
\ifx \advisorCnameC \itsempty \relax \else
\makebox[1.5cm][s]{}\makebox[3cm][l]{}\hfill
\makebox[3cm][s]{}\makebox[3cm][l]{\large{\advisorCnameC}}\\
\fi
\vspace{0.42cm}
\large{\univCname\deptCname}\\
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%       演算法目錄
%       (本論文沒有任何 algorithm 環境，開啟會產生空章節，故關閉)
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%\newpage
